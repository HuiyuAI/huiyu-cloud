...
class GenerateThread implements Runnable {
    ...
    private void compensateHandle() {
        ...
        UserBusiness userBusiness = SpringContext.getBean(UserBusiness.class);
        // 重试次数上限
...
//            task.setRetryCount(task.getRetryCount() + 1);
            ...
            // 回退积分
            userBusiness.updatePoint(task.getUserId(), task.getPoint(), PointOperationSourceEnum.FAIL_RETURN, PointOperationTypeEnum.ADD, task.getRequestUuid(), null);
